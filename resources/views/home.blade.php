    ...
    <div class="container-fluid">
        ...
        <script>
            $(function() {
                ...
                var pending = "<?php echo $pendingfw; ?>";
                var approved = "<?php echo $approvedfw; ?>";
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <ul class="chart-legend clearfix">
                                    <li style="font-size:24px;"><i class="fa fa-circle-o text-success"></i> Approved</li>
                                    <br>
                                    <li style="font-size:24px;"><i class="fa fa-circle-o text-warning"></i> Pending</li>
                                </ul>
                            </div>
                            <!-- /.col -->
                        </div>
